...
pub fn main() !void {
    ...
    var png_data: png.png_structp = png.png_create_read_struct(
    ...
    var png_info: png.png_infop = png.png_create_info_struct(png_data) orelse {
        std.debug.print("failed to create png info struct\n", .{});
        png.png_destroy_read_struct(&png_data, null, null);
        return error.Png;
    };

    var png_end_info: png.png_infop = png.png_create_info_struct(png_data) orelse {
